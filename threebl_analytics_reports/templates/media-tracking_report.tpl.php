<style type="text/css">
    ...
    .brdContMargin{margin: 0 0 5px}
    .cursor{cursor: default}
    .analyticsTriggerTxt{float: left; font-size: 12px; text-align: left; color: rgb(86, 92, 97); margin: 0px 5px 25px;}
    .selectFMr{width: 101px !important; padding-left: 5px !important}
    .width550{width: 550px}
    .txtalignrt{text-align: right; padding-right: 30px;}
    .blankli{text-align: right; border-top: 2px solid #F4F4F4; margin-top: 10px;}
    .txtalignlt{text-align: left;}
                ...
                <div class="rightSideCont"><?php echo $strTabHtml;?>
                    <div class="detailsContainer">
                            ...
                            <ul class="analyticsTrigger">
                            	<li>
                                    <div class="expTabsContainer">
                                        <div class="brdCont brdContMargin"> <span class="frstLink"><a href="javascript:void(0);" class="fistLink cursor">  TRACKING SUMMARY </a></span> </div>
                                    </div>
                                </li>
								<li><div class="analyticsTriggerTxt">
                                ...
                                <li class="traking-search" >
                                    <div>
                                        <span class="selectFMr"><strong>Select FMR:</strong></span>
                        ...
                        <?php } 
						 	...
						 	?>
                             <div class="views-row views-row-odd views-row-first mht txtaligncenter">

            ...
            <ul class="analyticsTrigger">
              ...
              <option value="">Select FMR</option>
                <?php if (!empty($arrLatestFmr)) {
                                        // check latest FMR array exits or not.if yes show the FMR Listing in drop-down.
              ...
              <div>
              <span>&nbsp;&nbsp;</span>
              <input type="text" name="search" id="keysearch" size="65" height="28px" class="height22" disabled="disabled" />&nbsp; &nbsp;

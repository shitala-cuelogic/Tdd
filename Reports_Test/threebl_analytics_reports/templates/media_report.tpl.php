<style type="text/css">
    .mediareporth3{margin-top: 0px !important;}
    .nodata{color: #0070C0 !important; font-size: 14px;}
</style>
...
<h3 class="mediareporth3"># Views </h3>
</div>
<div class="tableTd2">
<ul>
...
<div class="pad10">
<span class="nodata">No View data available for the current selected <strong><?php echo ucwords($strTitle); ?></strong> media from
last six months.<br>
</span>
</div>
